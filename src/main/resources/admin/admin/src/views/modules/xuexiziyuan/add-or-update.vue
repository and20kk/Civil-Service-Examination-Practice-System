<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-else-if="ruleForm.ziyuanxiangqing" label="资源详情" prop="ziyuanxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.ziyuanxiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.ziyuanxiangqing = this.ruleForm.ziyuanxiangqing.replace(reg,'../../../springbootq5xf6w8j/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
