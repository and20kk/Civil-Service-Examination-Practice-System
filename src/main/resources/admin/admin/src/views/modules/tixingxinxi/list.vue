		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #fff","padding":"10px","margin":"0","flexWrap":"wrap","background":"#ffffff","display":"flex","width":"100%"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 20px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">用户姓名</label>
			...
			<div :style='{"border":"0px solid #fff","width":"100%","padding":"0 20px 20px","fontSize":"14px","color":"#000","background":"#fff"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column  :resizable='true' prop="tixingfengmian" width="200" label="提醒封面">
						<template slot-scope="scope">
							<div v-if="scope.row.tixingfengmian">
								<img v-if="scope.row.tixingfengmian.substring(0,4)=='http'&&scope.row.tixingfengmian.split(',w').length>1" :src="scope.row.tixingfengmian" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.tixingfengmian)">
								<img v-else-if="scope.row.tixingfengmian.substring(0,4)=='http'" :src="scope.row.tixingfengmian.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.tixingfengmian.split(',')[0])">
								<img v-else :src="$base.url+scope.row.tixingfengmian.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView($base.url+scope.row.tixingfengmian.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
