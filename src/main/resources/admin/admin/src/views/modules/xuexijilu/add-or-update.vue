<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-if="type!='info'"  label="练习情况" prop="lianxiqingkuang" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.lianxiqingkuang" 
					class="editor"
					myQuillEditor="lianxiqingkuang"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.lianxiqingkuang" label="练习情况" prop="lianxiqingkuang" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.lianxiqingkuang"></span>
			</el-form-item>
			<el-form-item v-if="type!='info'"  label="学习记录" prop="xuexijilu" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.xuexijilu" 
					class="editor"
					myQuillEditor="xuexijilu"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.xuexijilu" label="学习记录" prop="xuexijilu" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.xuexijilu"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='lianxiqingkuang'){
							this.ruleForm.lianxiqingkuang = obj[o];
							this.ro.lianxiqingkuang = true;
							continue;
						}
						if(o=='xuexijilu'){
							this.ruleForm.xuexijilu = obj[o];
							this.ro.xuexijilu = true;
							continue;
						}
					}
				}
				...
				this.xuexijinduOptions = "20%,40%,60%,80%,100%".split(',')
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.lianxiqingkuang = this.ruleForm.lianxiqingkuang.replace(reg,'../../../springbootq5xf6w8j/upload');
						this.ruleForm.xuexijilu = this.ruleForm.xuexijilu.replace(reg,'../../../springbootq5xf6w8j/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
