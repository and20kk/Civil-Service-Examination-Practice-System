<template>
	<div :style='{"width":"100%","padding":"20px 30px","fontSize":"15px"}'>
		<el-form
			:style='{"padding":"40px 20% 40px 10%","borderColor":"#eee","borderRadius":"10px","borderStyle":"solid","borderWidth":"1px","background":"#ffffff"}'
			...
			label-width="180px"
		>
			<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}' label="选择题库" prop="paperid">
				<el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择题库">
					<el-option
			...
			<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}' label="题目" prop="questionname">
				<editor
			...
			<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}' v-if="ruleForm.type==0 && options.length>0" label="答案" prop="answer">
			...
			<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}' v-if="ruleForm.type==1 && options.length>0" label="答案" prop="answer">
			...
			<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}' v-if="ruleForm.type==2 && options.length>0" label="答案" prop="answer">
				<el-select v-model="ruleForm.answer" @change="answerChange">
					<el-option
						:label="item.text"
						:value="item.code"
			...
			<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}' v-if="ruleForm.type==3" label="答案" prop="answer">
				<el-input v-model="ruleForm.answer" placeholder="答案" clearable @input="answerChange"></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 22px 0","display":"inline-block"}' label="分数" prop="score">
	...
	export default {
		data() {
			...
			return {
				...
				rules: {
					paperid: [{ required: true, message: "请选择题库", trigger: "blur" }],
					questionname: [
