		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">学习进度</div>
						<div class="text "  >{{detail.xuexijindu}}</div>
					</div>
					<div class="btn_box">
			...
			<el-tabs class="detail-tabs" v-model="activeName" type="border-card" v-if="tabsNum>0" >
				<el-tab-pane label="练习情况" name="first">
					<div class="ql-snow ql-editor" v-html="detail.lianxiqingkuang"></div>
				</el-tab-pane>
				<el-tab-pane label="学习记录" name="first1">
					<div class="ql-snow ql-editor" v-html="detail.xuexijilu"></div>
				</el-tab-pane>
			</el-tabs>
