	...
	<div>
		...
		<div class="list-preview">
			...
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('xuexiziyuan','新增')" type="primary" @click="add('/index/xuexiziyuanAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`xuexiziyuan/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/xuexiziyuanDetail', query: params});
			},
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.list-preview {
		...
		.category-3 {
			...
			.item:hover {
				color: #fff;
				background: linear-gradient(0,rgb(39, 103, 205),rgb(25, 190, 212));
				border-color: #000;
			}
			.item.active {
				color: #fff;
